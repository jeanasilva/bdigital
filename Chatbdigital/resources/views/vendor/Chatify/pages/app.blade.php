...
<div class="messenger">
    ...
    <div class="messenger-listView">
        ...
        <div class="m-body">
           ...
           <div class="@if($route == 'group') show @endif messenger-tab app-scroll" data-view="groups">
                {{-- items --}}
                <p style="text-align: center;color:grey;">Em breve disponivel</p>
             </div>

             {{-- ---------------- [ Search Tab ] ---------------- --}}
           <div class="messenger-tab app-scroll" data-view="search">
                {{-- items --}}
                <p class="messenger-title">Pesquisar</p>
    ...
    <div class="messenger-messagingView">
        ...
        <div class="internet-connection">
            <span class="ic-connected">Você está Online</span>
            <span class="ic-connecting">Conectando...</span>
            <span class="ic-noInternet">Sem Internet</span>
        </div>
        {{-- Messaging area --}}
        <div class="m-body app-scroll">
            <div class="messages">
                <p class="message-hint" style="margin-top: calc(30% - 126.2px);"><span>Selecionar um chat para Conectar</span></p>
            </div>
            {{-- Typing indicator --}}
