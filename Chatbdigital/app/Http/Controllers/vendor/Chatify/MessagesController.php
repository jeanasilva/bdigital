...
class MessagesController extends Controller
{
    ...
    public function fetch(Request $request)
    {
        ...
        return Response::json([
            'count' => $query->count(),
            'messages' => '<p class="message-hint"><span>Diga \'oi\' e inicie uma conversa</span></p>',
        ]);
    }
    ...
    public function getContacts(Request $request)
    {
        ...
        // send the response
        return Response::json([
            'contacts' => $users->count() > 0 ? $contacts : '<br><p class="message-hint"><span>Sua lista de favoritos está vazia</span></p>',
        ], 200);
    }
